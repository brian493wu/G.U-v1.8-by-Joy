...
if(window.location.pathname === "/index.html" || window.location.pathname === "/") {
  ...
  const options = ["Hosted on the best hardware!", "Do not share this link with anyone.", "Join our Discord for more cool things!", "Join our Discord for more cool things!", "© Copyright 2024 Unlocked Joy. All Rights Reserved.", ];
